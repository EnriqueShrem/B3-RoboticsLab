...
Integer i
For i = 0 To 9
       Go P2 +Z((6 * n) + (6 * (5 + i))) 'Goes to the Block Picking Positions
       Go P2 +Z((6 * n) - (6.2 * i))
       On 8
       Wait 0.5
           
       Go P2 +Z((6 * n) - (6.2 * i) + 2)
       Go P2 -X(15) +Y(15) +Z((6 * n) + (6 * (5 + i))) 'Goes to the Placing Position to Leave the Block
       Go P1 -X(15) +Y(15) +Z((6 * n) + (6 * (5 + i)))
       Go P8 +Z(24 + (12 * i))
       Go P8 +Z(6 + (12 * i))
       Wait 0.5
       Off 8
       
       Go P8 +Z(24 + (12 * i)) 'Goes to the Coin Picking Position
       Go P1 +Z((6 * n) + (6 * (5 + i)))
       Go P1 +Z((6 * n) - (6.2 * i))
       On 8
       Wait 0.5
       ...
       Go P1 +Z((6 * n) - (6.2 * i) + 2)
       Go P1 -X(20) +Z((6 * n) + (6 * (5 + i))) 'Goes to the Placing Position to leave the Coin
       Go P8 +Z(30 + (12 * i))
       Go P8 +Z(12 + (12 * i))
       Wait 0.5
       Off 8
       
       Go P8 +Z(30 + (12 * i)) 'Ends Action
       Next i
Fend
```
